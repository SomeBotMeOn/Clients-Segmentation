...
## Ошибки работы:
1) Генерация метрик по колонкам по всему датасету, из-за чего возник лик в данных в последствии на тестовой выборке с увеличением точности
2) Использование классификации для оценки кластеризации вместо, например, силуэт скора
